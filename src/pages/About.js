    ...
    <CodeBlock>
      ...
      <CodeLine>
        <TagContents indent={4}>
          ...
          입니다.
          <br />
          실제로 같이 일했던 팀원분이 제가 만든 마크업 페이지는 개발하기 쉽다고
          말씀해주셔서
          <br />
          뿌듯했던 기억이 있습니다. ✨
        </TagContents>
      ...
      <CodeLine>
        <TagContents indent={4}>
          <br />
          제가 하는 일을 좋아하고, 스스로 부족한 부분을 잘 알기에 개발 공부하는
          것이 즐겁습니다.
          <br />
          ...
          <br />
          각자의 부족함을 서로 채우고, 재능을 인정하는 것이 좋은 기업과 서비스를
          만드는 열쇠라고 생각하며 일합니다.
        </TagContents>
      </CodeLine>
      ...
      <CodeLine>
        <TagContents indent={6}>
          ...
          <p>
            - 클래스, 콜백, 프로미스, 클로저를 이해하기 위해 공부하고 있습니다.
          </p>
        </TagContents>
      </CodeLine>
